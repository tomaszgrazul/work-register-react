...
const ModalWorkGasD = ({setOpenModal, handleAddModal}) => {
    ...
    useEffect(() => {
        handleAddModal(registerGroup.toString(), 'workGasD');      
    }, [registerGroup]);
        ...
        <div className="modalGroup">
            <div className='xModal'>
                <div className='xModal1'>
                    <p onClick={() => {setOpenModal(() => {return {workGasD: false}})}}>X</p>
                </div> 
            </div> 
            {/* <div>
            ...
            <table>
                <tbody>
                    ...
                    }   } /></th><th className="nameGroup">Prace gazoniebezpieczne</th></tr>
                                <tr>

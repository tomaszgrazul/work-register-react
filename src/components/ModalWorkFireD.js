...
const ModalWorkFireD = ({setOpenModal, handleAddModal}) => {
    ...
    useEffect(() => {
        handleAddModal(registerGroup.toString(), 'workFireD');      
    }, [registerGroup]);
        ...
        <div className="modalGroup">
            <div className='xModal'>
                <div className='xModal1'>
                    <p onClick={() => {setOpenModal(() => {return {workFireD: false}})}}>X</p>
                </div> 
            </div> 
            {/* <div>
